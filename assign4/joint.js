...
Joint.prototype.getLocalMatrix = function () {
    var rotationMatrix = Matrix.rotate(this.mJointAngle, 0, 0, 1);
    var localFrameMatrix = Matrix.frame(this.mForward, this.mUp, this.mJointAxis, this.mPosition);
    return localFrameMatrix.multiply(rotationMatrix);
}
...
Joint.prototype.getWorldMatrix = function () {
	var worldMatrix = this.getLocalMatrix();

    if (this.mParent) {
        var parentWorldMatrix = this.mParent.getWorldMatrix();
        worldMatrix = parentWorldMatrix.multiply(worldMatrix);
    }
...
// ################ Edit your code below
	...
	this.mBindingMatrix = worldMatrix.inverse();
// ################

...
// ################ Edit your code below
    var translationToOrigin = SimpleMatrix.translate(point[0], point[1], point[2]);
    var rotationMatrix = SimpleMatrix.rotate(angle, axis[0], axis[1], axis[2]);
    var translationBack = SimpleMatrix.translate(-point[0], -point[1], -point[2]);

    mat = SimpleMatrix.multiply(translationToOrigin, rotationMatrix);
    mat = SimpleMatrix.multiply(mat, translationBack);
// ################

...
// ################ Edit your code below
    var viewProjection = projection.multiply(view.inverse());
    var modelViewProjectionMatrix = viewProjection.multiply(model);
    var viewportMatrix = SimpleMatrix.viewport(canvas.width, canvas.height);
    var fullTransformChain = viewportMatrix.multiply(modelViewProjectionMatrix);
// ################
...
// ################ Edit your code below
        var transformedVertex1 = SimpleMatrix.multiplyVector(fullTransformChain, xyz1);
        var transformedVertex2 = SimpleMatrix.multiplyVector(fullTransformChain, xyz2);

        var projectedX1 = transformedVertex1[0] / transformedVertex1[3];
        var projectedY1 = transformedVertex1[1] / transformedVertex1[3];
        var uv1 = [projectedX1, projectedY1];

        var projectedX2 = transformedVertex2[0] / transformedVertex2[3];
        var projectedY2 = transformedVertex2[1] / transformedVertex2[3];
        var uv2 = [projectedX2, projectedY2];
// ################

...
color ray_color(const ray r, const Sphere spheres[35]) {
...
void main() {
    ...
    material ground_material = material(vec3(0.5, 0.5, 0.5), 1, 0.0);
    material material1 = material(vec3(0.9, 0.9, 0.9), 3, 1.5); 
    material material2 = material(vec3(0.4, 0.2, 0.1), 1, 0.0); 
    material material3 = material(vec3(0.7, 0.6, 0.5), 2, 0.0); 
